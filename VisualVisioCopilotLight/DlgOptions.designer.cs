...
namespace VisualVisioCopilotLight
  ...
  partial class DlgOptions
    ...
    private void InitializeComponent()
      ...
      this.edWebView2Path = new System.Windows.Forms.TextBox();
      this.labWebView2Path = new System.Windows.Forms.Label();
      this.btnWebView2Explore = new System.Windows.Forms.Button();
      ...
      // tabPage2
      // 
      this.tabPage2.Controls.Add(this.btnWebView2Explore);
      this.tabPage2.Controls.Add(this.edWebView2Path);
      this.tabPage2.Controls.Add(this.labWebView2Path);
      ...
      // edWebView2Path
      // 
      resources.ApplyResources(this.edWebView2Path, "edWebView2Path");
      this.edWebView2Path.Name = "edWebView2Path";
      // 
      // labWebView2Path
      // 
      resources.ApplyResources(this.labWebView2Path, "labWebView2Path");
      this.labWebView2Path.Name = "labWebView2Path";
      // 
      // btnWebView2Explore
      // 
      resources.ApplyResources(this.btnWebView2Explore, "btnWebView2Explore");
      this.btnWebView2Explore.Name = "btnWebView2Explore";
      this.btnWebView2Explore.UseVisualStyleBackColor = true;
      this.btnWebView2Explore.Click += new System.EventHandler(this.btnWebView2Explore_Click);
      // 
      // DlgOptions
      // 
    ...
    private System.Windows.Forms.Button btnWebView2Explore;
    private System.Windows.Forms.TextBox edWebView2Path;
    private System.Windows.Forms.Label labWebView2Path;
    }
  }