...
namespace VisualVisioCopilotLight
  ...
  public partial class ThisAddIn
    ...
    static public VisualVisioCopilotLight addinApplication;
    static internal RibbonVisualVisioCopilotLight ribbonApplication;
    string strCulture;
    ...
    private void ThisAddIn_Startup(object sender, System.EventArgs e)
      ...
      addinApplication = new VisualVisioCopilotLight(visApplication, strCulture);
    ...
    protected override Microsoft.Office.Core.IRibbonExtensibility CreateRibbonExtensibilityObject()
      {
                ...
                UtlMeth.ReadRegistrySection(StringEx.GetString("idsCompanyName"), StringEx.GetString("idsApplicationName"),
                                            ...
                                            out strCulture);
#endif
      ThisAddIn.ribbonApplication = new RibbonVisualVisioCopilotLight(strCulture);
    ...
    #region fonctions évènementielles
      ...
      public void OnBeforeDocumentClose(Visio.Document visDocument)
        ...
        try
          {
          if (VisMeth.IsDocumentUserCellExist(visDocument, "VisualVisioCopilotLightDocType", "StandardDoc")||
